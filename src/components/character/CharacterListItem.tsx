...
const CharacterListItem: React.FC<{ character: ICharacter }> = ({
  character,
}) => {
  const theme = useTheme();
  const listItemRef = useRef<HTMLDivElement>(null);
  const [openItemContextMenu, setOpenItemContextMenu] =
  ...
  return (
    <>
      ...
      >
        <MenuItem onClick={() => handleListItemAction("delete")}>
          Delete
        </MenuItem>
        <MenuItem onClick={() => handleListItemAction("update")}>
          Update
        </MenuItem>
      </Menu>
    </>
