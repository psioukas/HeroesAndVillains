...
export const baseApiUrl: string | undefined =
...
export async function createCharacter(
  ...
  try {
    showInfoNotification(
      `Please wait creating character ${character.fullName}`,
    );
...
export async function getSpecificCharacter(
  characterId?: string,
): Promise<ICharacter | undefined> {
...
export async function updateCharacter(
  ...
  try {
    showInfoNotification(
      `Please wait updating character ${character.fullName}`,
    );
    const url = constructURL("character");
